...
class ResNet3D(nn.Module):
    def __init__(self, num_actions, image_channels=1, time_steps=4):
        ...
        # --- 最後融合 ---
        self.fc_final = nn.Linear(256 + 64, num_actions)
    ...
    def forward(self, x, coords=None):
        ...
        if coords is not None:
            coords = coords.squeeze(1)  # [B, 4]
            coords = self.coord_fc(coords)  # [B, 64]
